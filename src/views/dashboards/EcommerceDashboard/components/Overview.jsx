    ...
    return (
        <Card>
            <div className="flex items-center justify-between">
                <h4>{t('dashboard.overview') || 'Visão Geral'}</h4>
                <Select
                    className="w-[120px]"
                    size="sm"
                    placeholder={t('dashboard.selectPeriod') || 'Selecionar período'}
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4 rounded-2xl p-3 bg-gray-100 dark:bg-gray-700 mt-4">
                <StatisticCard
                    title={t('dashboard.totalProfit') || 'Lucro Total'}
                    value={
                        <NumericFormat
                            displayType="text"
                ...
                />
                <StatisticCard
                    title={t('dashboard.totalOrder') || 'Total de Pedidos'}
                    value={
                        <NumericFormat
                            displayType="text"
                ...
                />
                <StatisticCard
                    title={t('dashboard.impression') || 'Impressões'}
                    value={
                        <AbbreviateNumber
