    ...
    return (
        <AdaptiveCard className="h-full">
            <div className="flex flex-auto h-full">
                {/* Menu lateral sempre visível em telas md+ */}
                <div className="hidden md:block w-[200px] xl:w-[280px]">
                    <SettingsMenu />
                </div>
                <div className="flex-1 py-2 xl:ltr:pl-6 xl:rtl:pr-6">
                    {/* Menu mobile só em telas pequenas */}
