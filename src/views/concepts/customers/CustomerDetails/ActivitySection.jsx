...
const TimeLineContent = (props) => {
    ...
    switch (type) {
        case 'PRODUCT-VIEW':
            return (
                <div>
                    <h6 className="font-bold">Visualizar Plano</h6>
        ...
        case 'PRODUCT-UPDATE':
            return (
                <div>
                    <h6 className="font-bold">Alterar Plano</h6>
                    <p className="font-semibold">
                        {name} {description}
                    </p>
                </div>
        ...
        case 'SUPPORT-TICKET':
            return (
                <div>
                    <h6 className="font-bold">Ticket de Suporte</h6>
                    <p className="font-semibold">
                        {name} {description}
                    </p>
                </div>
        ...
        case 'TICKET-IN-PROGRESS':
            return (
                <div>
                    <h6 className="font-bold">Atualização de Ticket</h6>
